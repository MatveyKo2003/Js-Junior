...
Windows: NuGet — система управления пакетами, созданная Microsoft для использования в операционной системе Windows 10 
Linux: Entropy — система управления пакетами в Sabayon Linux.
